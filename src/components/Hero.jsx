...
const Hero = ({ className, children, text }) => {
  ...
  style={{ backgroundImage: `url(${img})` }}
>
  <div className="py-[110px] flex flex-col items-center justify-center bg-color-1 bg-opacity-50 px-4 sm:px-6 md:px-8">
    <h3 className="text-[2.1rem] font-bold text-center sm:text-3xl md:text-4xl">{children}</h3>
